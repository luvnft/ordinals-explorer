      ...
      <div className="w-full rounded-md bg-black">
        <div className="flex flex-col p-4 pb-8 sm:p-6 md:p-8 lg:p-12">
          <div className="flex flex-col justify-between gap-6 md:flex-row">
            <div className="flex gap-4 md:flex-col">
              ...
              <p className="text-sm text-neutral-0">
                ...
                <a className="underline" href="https://btcsats.luvnft">
                  LUV NFT BTCSATS
                </a>{' '}
            ...
            {/* Newsletter form */}
            <div className="digioh-form" id="lightbox-inline-form-8b0bbe84-51ac-4bfc-8af0-101231368a57" />
          </div>
          <div className="mt-10 flex flex-col justify-between space-y-4 text-center text-xs text-neutral-300 md:flex-row md:space-y-0">
            <div>
              <a href="https://tiktok.com/@luvnft">TikTok</a> &mdash;{' '}
            ...
            <div className="flex justify-center space-x-3">
              ...
              <FaDiscord className="inline-block h-4 w-4 text-neutral-0" />
              </Link>
              <Link href="https://luvnft.com" className="inline-block" target="_blank">
